                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>No</th><th>Type</th><th>Issue Date</th><th>Expire Date</th><th>Name</th><th>Birth Date</th><th>Id No</th><th>User Id</th><th>User Email</th><th>User Role</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($profiles as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->no }}</td><td>{{ $item->type }}</td><td>{{ $item->issue_date }}</td><td>{{ $item->expire_date }}</td><td>{{ $item->name }}</td><td>{{ $item->birth_date }}</td><td>{{ $item->id_no }}</td><td>{{ $item->user_id }}</td><td>{{ isset($item->user->email) ? $item->user->email : "" }}</td>
