                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Email</th><th>Email Verified At</th><th>Password</th>
                                        <th>Remember Token</th><th>Role</th><th>Profile No</th><th>Profile Type</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($users as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->email }}</td><td>{{ $item->email_verified_at }}</td>
                                        <td>{{ $item->password }}</td><td>{{ $item->remember_token }}</td><td>{{ $item->role }}</td>
                                        <td><td>{{ isset($item->profile->no) ? $item->profile->no : "" }}</td>
